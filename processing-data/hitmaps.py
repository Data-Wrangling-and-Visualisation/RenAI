...
def visualize_attention_map(cls_attn, image_pil, save_path):
    """
...
def process_image(img_path):
    ...
    visualize_attention_map(cls_attn, image.resize((224, 224)), save_path)

# === Обработка всех изображений в папке ===
image_files = [f for f in os.listdir(image_dir) if f.lower().endswith(('.jpg', '.jpeg', '.png'))]
for img_file in tqdm(image_files, desc="Generating attention maps"):
    try:
